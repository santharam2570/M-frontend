...
import { TwoStepForm } from "@/components/forms/two-step-form";

export const metadata: Metadata = {
  title: "Two-Step Verification | MAP Real Estate",
  description: "Verify your MAP account with a one-time code.",
};
