...
/** Default form drawer sizing — matches Add New Note */
export const sheetFormContentClassName =
  "data-[side=right]:sm:max-w-md p-0 flex flex-col h-full gap-0"
...
export {
  ...
  formMultiSelectTriggerClassName,
...
/** Wider drawer for compose email and similar rich forms */
export const sheetEmailContentClassName =
  "data-[side=right]:sm:max-w-xl p-0 flex flex-col h-full gap-0"
